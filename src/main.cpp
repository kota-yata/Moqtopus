...
namespace
{
    ...
    public:
        ...
        {
            std::cout << "object request=" << object.request_id
                      << " alias=" << object.track_alias
            ...
            {
                std::cout << " bytes=" << object.payload.size()
                          << " preview=\"" << PayloadPreview(object.payload) << '"';
            }
            std::cout << '\n';
        }
        ...
        {
            std::cout << "publish done status=" << done.status_code
    ...
    void Usage(const char *argv0)
    {
        std::cerr << "usage: " << argv0
                  << " <host> <port> <namespace[/field...]> <track-name>"
                     " [path] [alpn]\n"
                  << "example: " << argv0
                  << " localhost 4433 camera/front video / moqt-18\n";
    }
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        const moq::SubscriptionHandle subscription =
